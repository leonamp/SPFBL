...
##########################################
# Gerenciador de instalaÃ§ e remoÃ§    #                  
#               SPFBL                    #
##########################################
...
preInstall(){
    ...
    # Verifica se hÃ¡nstalaÃ§ e instala
    if [ -d /opt/spfbl ]; then
...
setaVariaveis(){
    ...
    # Setando variÃ¡is do ambiente para o auto-updater
...
#    
    	...
    	then
    	# Chama instalaÃ§ em plataforma DEBIAN
    ...
    # Chama instalaÃ§ em plataforma RHEL
...
if [ "$1" != "--install" ] && [ "$1" != "--uninstall" ]; then
    ...
    #########################################################################################
    # Abaixo estÃ£instruÃ§s que podem ser usadas em necessidade futura para
    # reconhecimento de arquitetura e de sistema debian especÃ­co
    #########################################################################################
    ...
    # NÃ£Ã©ecessÃ¡o uma instalaÃ§ especÃ­ca para Debain..
    # mas se um dia for
    #
