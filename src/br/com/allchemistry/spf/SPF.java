...
//            ArrayList<Mechanism> mechanismListNew,
//            Qualifier allNew,
//            String redirectNew,
//            String explanationNew,
//            boolean errorNew
//            ) {
//        if (mechanismList == null) {
//            return false;
//        } else if (mechanismList.size() != mechanismListNew.size()) {
//            return false;
//        } else if (all != allNew) {
//            return false;
//        } else if (redirect == null && redirectNew != null) {
//            return false;
//        } else if (explanation == null && explanationNew != null) {
//            return false;
//        } else if (error != errorNew) {
//            return false;
//        } else if (redirect != null && !redirect.equals(redirectNew)) {
//            return false;
//        } else if (explanation != null && !explanation.equals(explanationNew)) {
//            return false;
//        } else {
//            for (int index = 0; index < mechanismList.size(); index++) {
//                Mechanism mechanism1 = mechanismList.get(index);
//                Mechanism mechanism2 = mechanismListNew.get(index);
//                if (!mechanism1.equals(mechanism2)) {
//                    return false;
//                }
//            }
//            return true;
