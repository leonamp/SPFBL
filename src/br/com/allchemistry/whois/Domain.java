...
//            String dslastokNew,
//            String saciNew,
//            ArrayList<String> nameServerListNew,
//            boolean reducedNew
//            ) {
//        if (ownerNew == null && owner != null) {
//            return false;
//        } else if (owneridNew == null && ownerid != null) {
//            return false;
//        } else if (responsibleNew == null && responsible != null) {
//            return false;
//        } else if (countryNew == null && country != null) {
//            return false;
//        } else if (owner_cNew == null && owner_c != null) {
//            return false;
//        } else if (admin_cNew == null && admin_c != null) {
//            return false;
//        } else if (tech_cNew == null && tech_c != null) {
//            return false;
//        } else if (billing_cNew == null && billing_c != null) {
//            return false;
//        } else if (createdNew == null && created != null) {
//            return false;
//        } else if (expiresNew == null && expires != null) {
//            return false;
//        } else if (changedNew == null && changed != null) {
//            return false;
//        } else if (providerNew == null && provider != null) {
//            return false;
//        } else if (statusNew == null && status != null) {
//            return false;
//        } else if (dsrecordNew == null && dsrecord != null) {
//            return false;
//        } else if (dsstatusNew == null && dsstatus != null) {
//            return false;
//        } else if (dslastokNew == null && dslastok != null) {
//            return false;
//        } else if (saciNew == null && saci != null) {
//            return false;
//        } else if (nameServerListNew.size() != nameServerList.size()) {
//            return false;
//        } else if (reducedNew != reduced) {
//            return false;
//        } else if (ownerNew != null && !ownerNew.equals(owner)) {
//            return false;
//        } else if (owneridNew != null && !owneridNew.equals(ownerid)) {
//            return false;
//        } else if (responsibleNew != null && !responsibleNew.equals(responsible)) {
//            return false;
//        } else if (countryNew != null && !countryNew.equals(country)) {
//            return false;
//        } else if (owner_cNew != null && !owner_cNew.equals(owner_c)) {
//            return false;
//        } else if (admin_cNew != null && !admin_cNew.equals(admin_c)) {
//            return false;
//        } else if (tech_cNew != null && !tech_cNew.equals(tech_c)) {
//            return false;
//        } else if (billing_cNew != null && !billing_cNew.equals(billing_c)) {
//            return false;
//        } else if (createdNew != null && !createdNew.equals(created)) {
//            return false;
//        } else if (expiresNew != null && !expiresNew.equals(expires)) {
//            return false;
//        } else if (changedNew != null && !changedNew.equals(changed)) {
//            return false;
//        } else if (providerNew != null && !providerNew.equals(provider)) {
//            return false;
//        } else if (statusNew != null && !statusNew.equals(status)) {
//            return false;
//        } else if (dsrecordNew != null && !dsrecordNew.equals(dsrecord)) {
//            return false;
//        } else if (dsstatusNew != null && !dsstatusNew.equals(dsstatus)) {
//            return false;
//        } else if (dslastokNew != null && !dslastokNew.equals(dslastok)) {
//            return false;
//        } else if (saciNew != null && !saciNew.equals(saci)) {
//            return false;
//        } else {
//            for (int index = 0; index < nameServerList.size(); index++) {
//                String nameServer1 = nameServerList.get(index);
//                String nameServer2 = nameServerListNew.get(index);
//                if (!nameServer1.equals(nameServer2)) {
//                    return false;
//                }
//            }
//            return true;
