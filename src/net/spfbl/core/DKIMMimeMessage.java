 ...
 * @author leand
 */
public class DKIMMimeMessage extends SMTPDKIMMessage {
    
    public DKIMMimeMessage(Session sn, DKIMSigner dkims) {
        super(sn, dkims);
    }
    
    public DKIMMimeMessage(MimeMessage message, DKIMSigner dkims) throws MessagingException {
        super(message, dkims);
    }
